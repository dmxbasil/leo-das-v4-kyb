...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('🔔 Updates 🤖', url='https://t.me/+pArxGD4gcUtlYjhl'),
    ...
    if not spoll:
        ...
        if 2 < len(message.text) < 100:
            ...
            if not files:
                ...
                l = await message.reply_text(text=f"△ 𝙷𝚎𝚢 `{message.from_user.first_name}` 😎,\n\nʏᴏᴜʀ ʀᴇQᴜᴇꜱᴛ ʜᴀꜱ ʙᴇᴇɴ ꜱᴇɴᴛ",
                                                                                                       reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("━ • │▌║  ᗩᗪᗪ ʍɛ 2 ᑌᖇ Ǥᖇᗝᑌᑭ  ║▌│ • ━", url=f'http://t.me/{temp.U_NAME}?startgroup=true')],[InlineKeyboardButton("channel", url="https://t.me/+pArxGD4gcUtlYjhl"), InlineKeyboardButton("group", url="https://t.me/Cinema_Kottaaram"), InlineKeyboardButton("✪ Main Ch- ✪", url="https://t.me/+pArxGD4gcUtlYjhl")],[InlineKeyboardButton("close", callback_data="close_data")]]))
