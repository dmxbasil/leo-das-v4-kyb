...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('📢 ᴜᴘᴅᴀᴛᴇs', url='https://t.me/+vQMUxIgYus01YjNl')
            ],
            [
                InlineKeyboardButton('⚠️ ʜᴇʟᴘ', url=f"https://t.me/{temp.U_NAME}?start=help"),
            ],[
            InlineKeyboardButton('ɢʀᴏᴜᴩ', url='https://t.me/Cinema_Kottaaram')
            ]]
        ...
        btn = [
            [
                InlineKeyboardButton(
                    "🤖 ᴊᴏɪɴ ᴛᴏ ᴍʏ ᴜᴘᴅᴀᴛᴇs ᴄʜᴀɴɴᴇʟ", url=invite_link.invite_link
                )
            ],
