class script(object):
    START_TXT = """ʜᴇʟʟᴏ {},
ɪᴀᴍ <a href=https://t.me/{}>{}</a>,\n\n ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴩ ᴡɪᴛʜ ᴀᴅᴍɪɴ ᴩᴇʀᴍɪꜱꜱɪᴏɴ ᴀɴᴅ ɪ ᴡɪʟʟ ᴩʀᴏᴠɪᴅᴇ ᴍᴏᴠɪᴇꜱ/ꜱᴇʀɪᴇꜱ ᴡʜᴀᴛᴇᴠᴇʀ ʏᴏᴜ ᴡᴀɴᴛ \n ᴏʀ ᴇʟꜱᴇ ʏᴏᴜ ᴄᴀɴ ꜱᴇᴀʀᴄʜ ʜᴇʀᴇ ᴀʟꜱᴏ """
    LZTHMB_TEXT = """Hello {},
•••
    """
    LZLINK_TEXT = """Hey {},
...
•••
    """
    REQ_AUTH_TEXT = """Hello {},
\nYou must have to be the Authentic User to complete this operation...
    """
...
<b>URL buttons:</b>
<code>[Button Text](buttonurl:https://t.me/+U_BsDS31fbwwZjM1)</code>
